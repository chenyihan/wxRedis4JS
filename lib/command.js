...
function combineScoreMemberArgs(scoreMemberPairs) {
	var args = [];
	if (scoreMemberPairs === undefined || scoreMemberPairs === null) {
		return args;
	}
	for (var i = 0; i < scoreMemberPairs.length; i++) {
		var scoreMemberPair = scoreMemberPairs[i];
		args.push(scoreMemberPair.score);
		args.push(scoreMemberPair.member);
	}
	return args;
}
...
module.exports.combineScoreMemberArgs = combineScoreMemberArgs;
